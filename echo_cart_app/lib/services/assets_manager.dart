...
// general images
  ...
  static String about = "$profileImagesPath/about.png";
  // Bag
  static String bagWish = "$bagImagesPath/bag_wish.png";
  static String cart = "$bagImagesPath/cart.png";
  static String logo = "$bagImagesPath/logo.png";
  ...
  // Categories path
  static String cane = "$categoriesImagesPath/cane.png";
  static String coconut = "$categoriesImagesPath/coconut.png";
  static String mask = "$categoriesImagesPath/mask.png";
  static String pot = "$categoriesImagesPath/pot.png";
  static String puppet = "$categoriesImagesPath/puppet.png";
  static String clothes = "$categoriesImagesPath/clothes.png";
}
